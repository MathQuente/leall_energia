...
export function Services(){
    return(
        ...
        <div className='bg-white mb-10'>
             <div className='bg-white gap-4 md:mx-5 lg:mx-30 mx-auto'>
                <div className='flex flex-col md:flex-row p-10 items-center justify-center gap-20'>
                    <div className='flex flex-col justify-center'>
                        ...
                        <ul className="text-xl text-gray-900 box-content pt-10">
                            <li className='mb-4'><MdOutlineCheck className='inline-block text-blue-900'/>Luvas, ferramentas e varas de manobra;</li>
                            <li className='mb-4'><MdOutlineCheck className='inline-block text-blue-900'/>Ponta de prova, capacete e bota de segurança;</li>
                            <li className='mb-4'><MdOutlineCheck className='inline-block text-blue-900'/>Mantas, tapetes e mangotes isolantes;</li>
                            <li className='mb-4'><MdOutlineCheck className='inline-block text-blue-900'/>Aterramento, bastão de salvamento, lança e cesto aéreo;</li>
                            <li className='mb-4'><MdOutlineCheck className='inline-block text-blue-900'/>Banquetas, jampe de linha viva e bastões isolados;</li>
                            <li className='mb-4'><MdOutlineCheck className='inline-block text-blue-900'/>Coberturas isoladas para linha de distribuição.</li>
                        </ul>
                    </div>
